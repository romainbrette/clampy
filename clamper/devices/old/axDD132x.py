'''
This is the interface to the Digidata DLL.
This is taken from Pyme.
https://bitbucket.org/david_baddeley/python-microscopy/src/60c9379235f90b2c96afcf735099c69958563479/PYME/Acquire/Hardware/DigiData/?at=default
'''
from ctypes import *
...
_stdcall_libraries = {}
import os
os.chdir('C:\Axon\pCLAMP9.2')  ## This should obviously be changed!!
