...
project = u'clampy'
copyright = u'2019, Romain Brette'
author = u'Romain Brette'
...
latex_documents = [
    (master_doc, 'clampy.tex', u'clampy Documentation',
     u'clampy authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'clampy', u'clampy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'clampy', u'clampy Documentation',
     author, 'clampy', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    clampy_dir = os.path.abspath(os.path.join(os.path.dirname(__file__),
                                                   '..', 'clampy'))
