...
board.set_analog_input('output1', channel=4, deviceID='SCALED OUTPUT 1', gain=amplifier.get_gain)
board.set_analog_input('output2', channel=5, deviceID='SCALED OUTPUT 2', gain=amplifier.get_gain)
...
board.set_analog_input('I2', channel=6, deviceID='I', gain=amplifier.get_gain)
